  ...
  return (
    <footer className="border-t  ">
      <div className="max-w-7xl mx-auto px-6 md:px-20 py-20">
        ...
        {/* CONTENIDO */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-14 items-start text-gray-950 dark:text-gray-200">

          {/* LOGO + DESCRIPCIÓN */}
          <div className="flex flex-col gap-4">
            <h2 className="text-2xl font-semibold italic tracking-tight text-gray-950 dark:text-white">
              Air Cool
            </h2>
            <p className="max-w-sm text-gray-900 dark:text-gray-400 leading-relaxed">
        ...
        {/* DIVISOR */}
        <div className="my-14 border-t border-gray-200 0" />
